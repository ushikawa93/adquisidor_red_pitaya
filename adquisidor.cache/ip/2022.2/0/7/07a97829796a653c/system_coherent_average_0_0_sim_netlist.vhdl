...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_coherent_average is
  ...
  signal \finished_carry__0_i_1_n_0\ : STD_LOGIC;
  signal \finished_carry__0_i_2_n_0\ : STD_LOGIC;
  signal \finished_carry__0_i_3_n_0\ : STD_LOGIC;
  signal \finished_carry__0_i_4_n_0\ : STD_LOGIC;
  signal \finished_carry__0_n_0\ : STD_LOGIC;
  signal \finished_carry__0_n_1\ : STD_LOGIC;
  signal \finished_carry__0_n_2\ : STD_LOGIC;
  signal \finished_carry__0_n_3\ : STD_LOGIC;
  signal \finished_carry__1_i_1_n_0\ : STD_LOGIC;
  signal \finished_carry__1_i_2_n_0\ : STD_LOGIC;
  signal \finished_carry__1_i_3_n_0\ : STD_LOGIC;
  signal \finished_carry__1_n_2\ : STD_LOGIC;
  signal \finished_carry__1_n_3\ : STD_LOGIC;
  signal finished_carry_i_1_n_0 : STD_LOGIC;
  signal finished_carry_i_2_n_0 : STD_LOGIC;
  signal finished_carry_i_3_n_0 : STD_LOGIC;
  signal finished_carry_i_4_n_0 : STD_LOGIC;
  signal finished_carry_n_0 : STD_LOGIC;
  signal finished_carry_n_1 : STD_LOGIC;
  signal finished_carry_n_2 : STD_LOGIC;
  signal finished_carry_n_3 : STD_LOGIC;
  ...
  signal NLW_finished_carry_O_UNCONNECTED : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_finished_carry__0_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_finished_carry__1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  signal \NLW_finished_carry__1_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
...
finished_carry: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => finished_carry_n_0,
      CO(2) => finished_carry_n_1,
      CO(1) => finished_carry_n_2,
      CO(0) => finished_carry_n_3,
      CYINIT => '1',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => NLW_finished_carry_O_UNCONNECTED(3 downto 0),
      S(3) => finished_carry_i_1_n_0,
      S(2) => finished_carry_i_2_n_0,
      S(1) => finished_carry_i_3_n_0,
      S(0) => finished_carry_i_4_n_0
    );
\finished_carry__0\: unisim.vcomponents.CARRY4
     port map (
      CI => finished_carry_n_0,
      CO(3) => \finished_carry__0_n_0\,
      CO(2) => \finished_carry__0_n_1\,
      CO(1) => \finished_carry__0_n_2\,
      CO(0) => \finished_carry__0_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => \NLW_finished_carry__0_O_UNCONNECTED\(3 downto 0),
      S(3) => \finished_carry__0_i_1_n_0\,
      S(2) => \finished_carry__0_i_2_n_0\,
      S(1) => \finished_carry__0_i_3_n_0\,
      S(0) => \finished_carry__0_i_4_n_0\
    );
\finished_carry__0_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
      ...
      O => \finished_carry__0_i_1_n_0\
    );
\finished_carry__0_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
      ...
      O => \finished_carry__0_i_2_n_0\
    );
\finished_carry__0_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0009"
    )
        port map (
      ...
      O => \finished_carry__0_i_3_n_0\
    );
\finished_carry__0_i_4\: unisim.vcomponents.LUT6
    generic map(
      ...
      O => \finished_carry__0_i_4_n_0\
    );
\finished_carry__1\: unisim.vcomponents.CARRY4
     port map (
      CI => \finished_carry__0_n_0\,
      CO(3) => \NLW_finished_carry__1_CO_UNCONNECTED\(3),
      CO(2) => \^finished\,
      CO(1) => \finished_carry__1_n_2\,
      CO(0) => \finished_carry__1_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => \NLW_finished_carry__1_O_UNCONNECTED\(3 downto 0),
      S(3) => '0',
      S(2) => \finished_carry__1_i_1_n_0\,
      S(1) => \finished_carry__1_i_2_n_0\,
      S(0) => \finished_carry__1_i_3_n_0\
    );
\finished_carry__1_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
      ...
      O => \finished_carry__1_i_1_n_0\
    );
\finished_carry__1_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
      ...
      O => \finished_carry__1_i_2_n_0\
    );
\finished_carry__1_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
      ...
      O => \finished_carry__1_i_3_n_0\
    );
finished_carry_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
      ...
      O => finished_carry_i_1_n_0
    );
finished_carry_i_2: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
      ...
      O => finished_carry_i_2_n_0
    );
finished_carry_i_3: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
      ...
      O => finished_carry_i_3_n_0
    );
finished_carry_i_4: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
