...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_trigger_simulator is
  ...
  signal \counter_level[31]_i_2_n_0\ : STD_LOGIC;
  ...
  signal \counter_level_reg[31]_i_4_n_2\ : STD_LOGIC;
  signal \counter_level_reg[31]_i_4_n_3\ : STD_LOGIC;
  ...
  signal \NLW_counter_level_reg[31]_i_4_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_counter_level_reg[31]_i_4_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  attribute SOFT_HLUTNM of \counter_level[0]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \counter_level[10]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \counter_level[11]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \counter_level[12]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \counter_level[13]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \counter_level[14]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \counter_level[15]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \counter_level[16]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \counter_level[17]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \counter_level[18]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \counter_level[19]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \counter_level[1]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \counter_level[20]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \counter_level[21]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \counter_level[22]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \counter_level[23]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \counter_level[24]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \counter_level[25]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \counter_level[26]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \counter_level[27]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \counter_level[28]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \counter_level[29]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \counter_level[2]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \counter_level[30]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \counter_level[31]_i_3\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \counter_level[3]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \counter_level[4]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \counter_level[5]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \counter_level[6]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \counter_level[7]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \counter_level[8]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \counter_level[9]_i_1\ : label is "soft_lutpair4";
  ...
  attribute ADDER_THRESHOLD of \counter_level_reg[31]_i_4\ : label is 35;
...
\counter_level[31]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
      I0 => data_valid,
      I1 => \state_reg_n_0_[0]\,
      O => \counter_level[31]_i_2_n_0\
    );
\counter_level[31]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\counter_level_reg[31]_i_4\: unisim.vcomponents.CARRY4
     port map (
      CI => \counter_level_reg[28]_i_2_n_0\,
      CO(3 downto 2) => \NLW_counter_level_reg[31]_i_4_CO_UNCONNECTED\(3 downto 2),
      CO(1) => \counter_level_reg[31]_i_4_n_2\,
      CO(0) => \counter_level_reg[31]_i_4_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3) => \NLW_counter_level_reg[31]_i_4_O_UNCONNECTED\(3),
...
\state[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => state31_in,
      I4 => state3,
      I5 => \counter_level[31]_i_1_n_0\,
      O => \state[0]_i_1_n_0\
    );
\state[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00000000ECAC0000"
    )
        port map (
      I0 => \state_reg_n_0_[0]\,
      I1 => \state_reg_n_0_[1]\,
      I2 => data_valid,
      I3 => \state2_carry__2_n_0\,
      I4 => reset_n,
      I5 => user_reset,
      O => \state[1]_i_1_n_0\
    );
...
trigger_nivel_reg_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"000000008EAA0000"
    )
        port map (
      I0 => \^trig\,
      I1 => \state_reg_n_0_[0]\,
