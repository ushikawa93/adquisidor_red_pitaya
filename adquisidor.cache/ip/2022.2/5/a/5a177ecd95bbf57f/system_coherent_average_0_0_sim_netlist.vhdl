...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_coherent_average is
  ...
  attribute SOFT_HLUTNM of \index_3[0]_i_1\ : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of \index_3[8]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \index_3[9]_i_1\ : label is "soft_lutpair11";
...
state2_carry_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
        ...
        port map (
      I0 => averaged_cycles_1(10),
      I1 => N_ca(10),
      I2 => averaged_cycles_1(9),
      I3 => N_ca(9),
      I4 => N_ca(11),
...
bram_porta_clk_INST_0: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
