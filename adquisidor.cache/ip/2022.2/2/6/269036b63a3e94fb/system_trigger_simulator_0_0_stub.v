...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, reset_n, user_reset, data_valid, M_in, trig)
/* synthesis syn_black_box black_box_pad_pin="clk,reset_n,user_reset,data_valid,M_in[31:0],trig" */;
  input clk;
  input reset_n;
  input user_reset;
  input data_valid;
