...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, reset_n, user_reset, data_in, data_valid, 
  M_in, K_sobremuestreo_in, trigger_mode_in, trigger_level_in, trig)
/* synthesis syn_black_box black_box_pad_pin="clk,reset_n,user_reset,data_in[31:0],data_valid,M_in[31:0],K_sobremuestreo_in[31:0],trigger_mode_in[3:0],trigger_level_in[13:0],trig" */;
  input clk;
  input reset_n;
  input user_reset;
  input [31:0]data_in;
