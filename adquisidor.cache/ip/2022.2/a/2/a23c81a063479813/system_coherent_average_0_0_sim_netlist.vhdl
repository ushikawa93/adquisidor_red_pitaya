...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_coherent_average is
  port (
    ...
    bram_portb_rddata : in STD_LOGIC_VECTOR ( 15 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_coherent_average is
  ...
  signal data_vieja : STD_LOGIC_VECTOR ( 15 downto 0 );
  ...
  signal wr_enable : STD_LOGIC_VECTOR ( 0 to 0 );
  signal wr_enable_1 : STD_LOGIC_VECTOR ( 0 to 0 );
  signal wr_enable_2 : STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  signal \NLW_suma_reg[15]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
...
finished_INST_0_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
finished_INST_0_i_5: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000000001"
    )
        port map (
...
finished_INST_0_i_6: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000000000001"
    )
        port map (
...
\suma_reg[15]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3) => \NLW_suma_reg[15]_i_1_CO_UNCONNECTED\(3),
      CO(2) => \suma_reg[15]_i_1_n_1\,
      CO(1) => \suma_reg[15]_i_1_n_2\,
      CO(0) => \suma_reg[15]_i_1_n_3\,
      CYINIT => '0',
      DI(3) => '0',
      DI(2 downto 0) => data_reg_1(14 downto 12),
...
\wr_enable_1_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => '1',
      D => wr_enable(0),
...
\wr_enable_2_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => '1',
      D => wr_enable_1(0),
...
\wr_enable_3_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => '1',
      D => wr_enable_2(0),
...
\wr_enable_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => clk,
      CE => '1',
      D => data_valid,
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_coherent_average
     port map (
      ...
      bram_porta_wrdata(15 downto 0) => bram_porta_wrdata(15 downto 0),
      bram_portb_addr(6 downto 0) => \^bram_portb_addr\(6 downto 0),
      bram_portb_rddata(15 downto 0) => bram_portb_rddata(15 downto 0),
      clk => \^clk\,
