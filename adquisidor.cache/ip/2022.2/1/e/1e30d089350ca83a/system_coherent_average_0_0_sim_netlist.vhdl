...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_coherent_average is
  port (
    bram_porta_wrdata : out STD_LOGIC_VECTOR ( 0 to 0 );
    bram_portb_addr : out STD_LOGIC_VECTOR ( 6 downto 0 );
    \averaged_cycles_reg[21]_0\ : out STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_coherent_average is
  ...
  signal \^averaged_cycles_reg[21]_0\ : STD_LOGIC;
...
begin
  \averaged_cycles_reg[21]_0\ <= \^averaged_cycles_reg[21]_0\;
...
wr_enable_3_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"BA"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  signal \^bram_porta_addr\ : STD_LOGIC_VECTOR ( 6 downto 0 );
  signal \^bram_porta_wrdata\ : STD_LOGIC_VECTOR ( 2 to 2 );
  signal \^bram_portb_addr\ : STD_LOGIC_VECTOR ( 6 downto 0 );
...
begin
  ...
  bram_porta_wrdata(6) <= \<const0>\;
  bram_porta_wrdata(5) <= \<const0>\;
  bram_porta_wrdata(4) <= \<const0>\;
  bram_porta_wrdata(3) <= \<const0>\;
  bram_porta_wrdata(2) <= \^bram_porta_wrdata\(2);
  bram_porta_wrdata(1) <= \<const0>\;
  bram_porta_wrdata(0) <= \<const0>\;
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_coherent_average
     port map (
      ...
      bram_porta_wrdata(0) => \^bram_porta_wrdata\(2),
      bram_portb_addr(6 downto 0) => \^bram_portb_addr\(6 downto 0),
      clk => \^clk\,
