...
fid = fopen('datos_sinc_2048.dat', 'r');

% Ignora la primera línea
metadata= textscan(fgetl(fid), "Frecuencia_de_muestreo: %f Factor_de_sobremuestreo: %f Ciclos_de_promediacion: %f");
