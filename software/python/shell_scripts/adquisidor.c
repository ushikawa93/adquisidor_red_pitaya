...
int main(int argc, char **argv)
{
	...
	int32_t reads_trigger_stop [TRIG_N];
	...
	escribirArchivo(reads_chA,reads_chB,M,(float)125000000/K_sobremuestreo,N_promC,K_sobremuestreo,custom_pow(2,log2_divisor),reads_trigger_stop);
